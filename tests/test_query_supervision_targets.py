...
def test_query_target_builders_emit_fg_boundary_core_and_ownership() -> None:
...
def test_query_core_heatmap_target_stays_inside_elongated_object() -> None:
...
def test_query_core_heatmap_target_prefers_center_of_elongated_plateau_not_plateau_edge() -> None:
    instance_map = np.zeros((15, 15), dtype=np.int32)
    instance_map[6:9, 2:13] = 1
...
def test_query_core_heatmap_target_scales_support_with_image_resolution() -> None:
