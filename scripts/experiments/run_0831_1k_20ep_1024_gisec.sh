...
runner_log "${MODE}" "${RUN_LOG}" "[gisec-0831] mode=${MODE}"
runner_log "${MODE}" "${RUN_LOG}" "[gisec-0831] variant=${VARIANT}"
runner_log "${MODE}" "${RUN_LOG}" "[gisec-0831] dataset_root=${DATASET_ROOT}"
