...
For that reason, `GISEC v2` is defined as a replacement method, not a small patch on top of `v1`.

## 2. Overall Framework and Data Flow
`GISEC v2` follows a supervision-first pipeline:
