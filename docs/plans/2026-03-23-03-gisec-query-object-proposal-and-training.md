# GISEC Query Alpha Object Proposal and Training Implementation Plan
...
**Tech Stack:** PyTorch losses, connected components, local assignment logic, existing COCO-compatible export path with query-specific diagnostics.
