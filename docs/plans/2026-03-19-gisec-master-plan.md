# GISEC Method Master Plan

## Goal
Define the full `GISEC Method` method before spending more GPU time, so the next implementation phase has a stable supervision story, a stable module boundary, and a stable ablation matrix.
...
## v2 Core Hypothesis
`GISEC Method` should be built around a supervision-first idea:
...
## Document Outputs
- Main plan:
  - `docs/plans/2026-03-19-gisec-method-master-plan.md`
- Subplans:
  - `docs/plans/2026-03-19-01-gisec-method-gap-audit.md`
  - `docs/plans/2026-03-19-02-gisec-method-method-spec.md`
  - `docs/plans/2026-03-19-03-gisec-method-supervision-and-inference.md`
  - `docs/plans/2026-03-19-04-gisec-method-ablation-and-mvp.md`
- Main method note:
  - `docs/method/gisec-method-method.md`
