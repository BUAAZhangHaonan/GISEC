...
## Scope
- Rewrite README/hand-off docs to describe the GISEC story (problem setup, dataset contract, variant matrix, key results).
...
## Key Changes
- Create `docs/experiments`, `docs/results`, and `docs/method` outlines that summarize the matrix, diagnostics, and prototype bank contracts.
