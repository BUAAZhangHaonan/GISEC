...
| m2f16v2 | m2f16v2 | m2f16 配方 (512 pts/no aux) + 单类/bit-order/RGB ImageNet 归一化 | 16,536,770 | pending | **改 k100 跑**（08-30：6401 24GB 卡 OOM 放不下 batch8@1024，unit gisec-m2f16v2-train） |
