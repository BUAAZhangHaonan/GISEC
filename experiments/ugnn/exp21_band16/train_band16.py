"""E21: band weight x16 (fork of E20 train_band8.py, single-variable).

Only change vs E20: BAND_GAIN 7.0 -> 15.0, i.e. BCE weight 1 + 15*band
(band interior x16, was x8). Hypothesis: sharper seam logits make the mix
...
HM_W = 1.0
OFF_W = 1.0
BAND_GAIN = 15.0  # weight = 1 + 15*band -> band interior x16
EMA_DECAY = 0.999
