...
| E8c eval speedup | eval_fast.py: profile 16.4s/img = 4x config path (post 1.62/stats 1.12/RLE 0.60); keep FINAL md9+oracle (md6/12 cut per E6), main-proc GPU forward + Pool(6) CPU side forked pre-CUDA, parallel 100x bootstrap (same sampling); smoke bit-identical to E8b, 1.1 s/img RSS ~15G | running | unit ugnn-e8-eval3 PID 2163008 (MemoryMax=48G, CPUQuota=800%) started 2026-08-20 12:58 CST, ETA ~3h; eval2 stopped at 2250/3276 (superseded); commit 9d16320 | — | 2026-08-20 |
