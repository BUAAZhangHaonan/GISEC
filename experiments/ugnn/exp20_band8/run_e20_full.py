...
sys.path.insert(
    0,
    "/home/k100/zhn/electronic-components-grasp-and-segment/gisec/experiments/ugnn/exp09_centernet_seeds",
)
sys.path.insert(
    0,
    "/home/k100/zhn/electronic-components-grasp-and-segment/gisec/experiments/ugnn/lib",
)
...
sys.argv = [
    ...
    "fast",
    "--ckpt",
    f"{HERE}/runs/best.pth",
    "--out",
    f"{HERE}/eval_full_fast_090.json",
]
ec.main()
