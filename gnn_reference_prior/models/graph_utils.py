...
from gnn_reference_prior.models.reference_cache import ReferenceCache, cosine_similarity_map
...
def build_graph_batch(
    *,
    ...
    sim_cache = None
    if reference_cache is not None and "rgb" in variant:
    ...
    for label in labels:
        ...
        ref_depth = 0.0
        if reference_cache is not None and "rgbd" in variant:
        ...
        edge_features.append(
            feature_map.new_tensor(
                [
                    ...
                    area_delta,
                    aspect_delta,
                    shape_consistency if "shape" in variant else 0.0,
                ]
            )
        )
